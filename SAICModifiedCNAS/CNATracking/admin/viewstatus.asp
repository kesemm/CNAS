    ...
    <div align="center">
      <table class="Normal">
        ...
        <tr class="Body1">
          ...
          <td align="center">
            <a href="modify.asp?mtype=4&id=<% = rstStat("status_id") %>"><%=lang(cnnDB, "Edit")%></a>
            &nbsp;|&nbsp; <a href="confdelete.asp?mtype=4&id=<% = rstStat("status_id") %>"><%=lang(cnnDB, "Delete")%></a>
          </td>
        </tr>
        <%
          rstStat.MoveNext
      ...
      <p><form method="post" action="modify.asp?mtype=4"><input type="submit" value="<%=lang(cnnDB, "AddNew")%>&nbsp;<%=lang(cnnDB, "Status")%>"></form></p>
