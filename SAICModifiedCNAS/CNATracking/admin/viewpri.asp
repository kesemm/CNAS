    ...
    <div align="center">
      <table class="Normal">
        ...
        <tr class="Body1">
          ...
          <td align="center">
            <a href="modify.asp?mtype=3&id=<% = rstPriList("priority_id") %>"><%=lang(cnnDB, "Edit")%></a>
            &nbsp|&nbsp <a href="confdelete.asp?mtype=3&id=<% = rstPriList("priority_id") %>"><%=lang(cnnDB, "Delete")%></a>
          </td>
        </tr>
        <%
          rstPriList.MoveNext
      ...
      <p>
        <form method="post" action="modify.asp?mtype=3">
