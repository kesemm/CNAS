...
<form action="CompanyNPAForm.asp" method="post" id="CompanyNPAQuery" name="CompanyNPAQuery">
...
session("Here")="CompanyNPAQuery.asp"


%>

<P><center><font face="Arial Black" size=5 color=maroon><strong>CNAS Company NPA Data Lookup</strong></font></center>
<P></P>

<P>&nbsp;<P>

<p><font face="Arial" size="3"><font face="Arial"><strong><em>
Please enter the NPA and Company Name for your lookup....</p>
<br><br></FONT>
...
<input type="submit" value="Go" id="button1" name="submit">
    ...
    <tr>
        <td>
            ...
            size=3>Company Name:</FONT></FONT></STRONG> 
            </DIV>
        <td>
            <!--METADATA TYPE="DesignerControl" startspan
<OBJECT classid="clsid:B5F0E450-DC5F-11D0-9846-0000F8027CA0" height=21 
