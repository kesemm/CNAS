...
NPA=session("WebFileAvlNPA")
NPA=session("WebFileUtilNPA")
...
Sub Button1_onclick()
Response.Redirect "xca_WebNPAFilePre.htm"
End Sub
...
<TABLE align=center WIDTH=83.38% BORDER=0 CELLSPACING=0 CELLPADDING=0 height=201 style="HEIGHT: 201px; WIDTH: 542px">
    ...
    <TR>
        <TD>
    <TR>
        <TD align=middle><FONT face=Arial size=4><STRONG>You have generated 
            the NPA File &nbsp;<%Response.write NPA%> </STRONG></FONT> 
    <TR>
        <TD>
	<TR>
...
<!--METADATA TYPE="DesignerControl" endspan-->
            <!--METADATA TYPE="DesignerControl" startspan
<OBJECT classid="clsid:B6FC3A14-F837-11D0-9CC8-006008058731" height=27 
            id=Button1 style="HEIGHT: 27px; LEFT: 284px; TOP: 0px; WIDTH: 94px" 
            width=94>
	<PARAM NAME="_ExtentX" VALUE="6033">
	<PARAM NAME="_ExtentY" VALUE="714">
	<PARAM NAME="id" VALUE="Button1">
	<PARAM NAME="Caption" VALUE="Generate Individual  NPA Files">
	<PARAM NAME="Image" VALUE="">
	<PARAM NAME="AltText" VALUE="">
	<PARAM NAME="Visible" VALUE="-1">
	<PARAM NAME="Platform" VALUE="256">
...
{
	Button1.value = 'Generate Individual  NPA Files';
	Button1.setStyle(0);
}
