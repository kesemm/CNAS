...
<form action="MBI_Full_NPA_NXX_No_RC_Part1_pre.asp" method="post" id="MBI" name="MBI">
...
session("Here")="MBI_Full_NPA_NXX.asp"
%>
...
Please enter the NPA and NXX for your MBI request ...</p>
<br><br></FONT>
...
<td>
  <strong>NXX:<input TYPE="text" NAME="NXX" SIZE="3" MAXLENGTH="3"></strong><br>
</td>
        <td>
...
style="LEFT: 0px; TOP: 0px">
	...
	<PARAM NAME="State" VALUE="(TCConn=\qcnasapp\q,TCDBObject_Unmatched=\qSQL\sStatement\q,TCDBObjectName_Unmatched=\qselect\sdistinct\sNPA\sfrom\sxca_MBI\swhere\sStatus='S'\sorder\sby\sNPA\q,TCControlID_Unmatched=\qGetPart1NPA\q,TCPPConn=\qcnasapp\q,TCPPDBObject=\qTables\q,TCPPDBObjectName=\q\q,RCDBObject=\qRCSQLStatement\q,TCSQLStatement_Unmatched=\qselect\sdistinct\sNPA\sfrom\sxca_MBI\swhere\sStatus='S'\sorder\sby\sNPA\q,TCCursorType=\q3\s-\sStatic\q,TCCursorLocation=\q3\s-\sUse\sclient-side\scursors\q,TCLockType=\q3\s-\sOptimistic\q,TCCacheSize_Unmatched=\q10\q,TCCommTimeout_Unmatched=\q10\q,CCPrepared=0,CCAllRecords=1,TCNRecords_Unmatched=\q10\q,TCODBCSyntax_Unmatched=\q\q,TCHTargetPlatform=\q\q,TCHTargetBrowser_Unmatched=\qServer\s(ASP)\q,TCTargetPlatform=\qInherit\sfrom\spage\q,RCCache=\qRCBookPage\q,CCOpen=1,GCParameters=(Rows=0))">
	<PARAM NAME="LocalPath" VALUE="../">
...
function _initGetPart1NPA()
{
	...
	cmdTmp.CommandText = 'select distinct NPA from xca_MBI where Status=\'S\' order by NPA';
	rsTmp.CacheSize = 10;
	rsTmp.CursorType = 3;
