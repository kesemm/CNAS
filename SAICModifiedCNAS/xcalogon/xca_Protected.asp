...
'SQL statement is checking for all NPA/NXXs with a status of "P" and outputting the value 'Available'.  Can
'be checked using the recordsets' SQL builder
RecSQL="select NPA, NXX,Remarks, 'Protected' from xca_cocode Where Status =  '" & Status & " '"  & SQL0
...
'With Grid1, wherever a NPA and NXX has a status of "P"(protected), the unbound column prints out the word
'"Protected".  The unbound column is not actually reading the status of a CO Code.
...
style="LEFT: 0px; TOP: 0px">
	...
	<PARAM NAME="State" VALUE="(TCConn=\qcnasapp\q,TCDBObject_Unmatched=\qSQL\sStatement\q,TCDBObjectName_Unmatched=\qSELECT\sNPA,\sNXX,\sRemarks,\s'Protected'\sFROM\sxca_cocode\sWHERE\sStatus\s=\s'P'\q,TCControlID_Unmatched=\qCOCodeRec\q,TCPPConn=\qcnasapp\q,TCPPDBObject=\qTables\q,TCPPDBObjectName=\qT1\q,RCDBObject=\qRCSQLStatement\q,TCSQLStatement_Unmatched=\qSELECT\sNPA,\sNXX,\s'Protected'\sFROM\sxca_cocode\sWHERE\sStatus\s=\s'P'\q,TCCursorType=\q3\s-\sStatic\q,TCCursorLocation=\q3\s-\sUse\sclient-side\scursors\q,TCLockType=\q3\s-\sOptimistic\q,TCCacheSize_Unmatched=\q10\q,TCCommTimeout_Unmatched=\q10\q,CCPrepared=0,CCAllRecords=1,TCNRecords_Unmatched=\q10\q,TCODBCSyntax_Unmatched=\q\q,TCHTargetPlatform=\q\q,TCHTargetBrowser_Unmatched=\qServer\s(ASP)\q,TCTargetPlatform=\qInherit\sfrom\spage\q,RCCache=\qRCBookPage\q,CCOpen=0,GCParameters=(Rows=0))">
...
function _initCOCodeRec()
{
	...
	cmdTmp.CommandText = 'SELECT NPA, NXX,Remarks, \'Proetected\' FROM xca_cocode WHERE Status = \'P\'';
	rsTmp.CacheSize = 10;
	rsTmp.CursorType = 3;
...
<table border="0" cellpadding="2">
  <tr>
    <td nowrap><font color="maroon" face="Arial Black" size="5"><strong>NPA - CO Codes
    Protected List</strong></font></td>
  </tr>
</table>
</center></div>

<table Align="right" nowrap border="0" cellPadding="0" cellSpacing="0" height="23"
style="HEIGHT: 23px; WIDTH: 226px" width="226">
  <tr>
...
<table width="60%" ALIGN="center" border="0" cellspacing="5" cellpadding="1">
  <tr>
    <td align="right" nowrap><!--METADATA TYPE="DesignerControl" startspan
...
<!--METADATA TYPE="DesignerControl" endspan--> </td>
    <td align="left" nowrap><!--METADATA TYPE="DesignerControl" startspan
...
<!--METADATA TYPE="DesignerControl" endspan--> <font color="black" Face="Arial" size="2">(<em>Select a NPA to
    view the protected CO Codes</em>)</font> </td>
  </tr>
</table>
...
<table align="center" nowrap border="0" cellPadding="0" cellSpacing="0" height="149"
style="HEIGHT: 149px; WIDTH: 703px" width="703">
  <tr>
    <td noWrap align="middle"><!--METADATA TYPE="DesignerControl" startspan
<OBJECT classid="clsid:277FC3F2-E90F-11D0-B767-0000F81E081D" 
	...
	<PARAM NAME="ColumnsNames" VALUE="&quot;NPA&quot;,&quot;NXX&quot;,&quot;='Protected'&quot;">
	...
	<PARAM NAME="DisplayName" VALUE='"NPA","CO Code","Remarks"'>
...
Grid1.colAttributes[2] = '  WIDTH=255';
Grid1.colFormat[2] = '<Font Size=2 Face="Arial" Color=Black >';
Grid1.colData[2] = 'COCodeRec.fields.getValue(\'Remarks\')';
