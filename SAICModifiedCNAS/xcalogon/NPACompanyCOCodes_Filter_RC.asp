...
<TITLE>CNAS NPA Company CO Codes - Filtered by Exchange</TITLE>
<%
'****************************************************************************************
'* CVS File:      $RCSfile: NPACompanyCOCodes_Filter_RC.asp,v $
...
Filtered by Exchange: <%=request.querystring("RC")%></B><BR></P>
<%
...
SQLQueryText = "SELECT xca_COCode.OCN,EntityName,NXX,COStatusDescription As Status, " & _
		...
		"and RateCenter=" & "'" & request.querystring("RC") & "' "
...
<a href="/xcalogon/NPACompanyCOCodes_Filter_RC.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=OCN&RC=<%=request.querystring("RC")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
<TD align="center"><B>Company</B>
<a href="/xcalogon/NPACompanyCOCodes_Filter_RC.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=Company&RC=<%=request.querystring("RC")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
<TD align="center"><B>&nbsp; NXX</B>
<a href="/xcalogon/NPACompanyCOCodes_Filter_RC.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=NXX&RC=<%=request.querystring("RC")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
<TD align="center"><B>Status</B>
<a href="/xcalogon/NPACompanyCOCodes_Filter_RC.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=Status&RC=<%=request.querystring("RC")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
<TD align="center"><B>CLLI</B>
<a href="/xcalogon/NPACompanyCOCodes_Filter_RC.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=CLLI&RC=<%=request.querystring("RC")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
...
<TD align="center"> &nbsp;
<%=rstNPACompanyCOCodes("RateCenter")%> &nbsp;</TD>
</TR>
<%
...
+"$RCSfile: NPACompanyCOCodes_Filter_RC.asp,v $\n"
+"$Revision: 1.3 $\n"
