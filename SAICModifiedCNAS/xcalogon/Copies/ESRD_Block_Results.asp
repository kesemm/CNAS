...
SQLNPAESRDQry = "SELECT Tix,NPA,ESRD,COStatusDescription,EntityName,xca_ESRD.OCN,PublicRemarks,ReserveID,CNARemarks FROM xca_ESRD Left Join xca_status_codes ON xca_ESRD.Status=xca_status_codes.COStatus Left JOIN xca_Entity ON xca_ESRD.EntityID=xca_Entity.EntityID WHERE (((xca_ESRD.NPA)='" & aNPA &"') AND ((xca_ESRD.ESRD) Like '" & aESRD & "%')) Order By ESRD;"
