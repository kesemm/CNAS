...
session("ESRD")=ESRD
SyncField=now()
SQLget= "Select Tix from xca_ESRD_Part1 where NPA='"&NPA&"' and ESRD='"&ESRD&"'"
...
SQLstmt = "INSERT INTO xca_ESRD_Part3 (Tix,AuthorizedRep,ApplicationDate,NPA,ESRD,SyncField, UserID, EntityID) VALUES ('"&RetrieveTix&"', '"&AuthorizedRep&"','"&ApplicationDate&"','"&NPA&"','"&ESRD&"','"&SyncField&"', '"&UserID&"', '"&UserEntityID &"')"
