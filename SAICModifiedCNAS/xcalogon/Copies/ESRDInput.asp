...
sql1 = "Select  ESRD from xca_ESRD where (Status='S' and (ReserveID='"&UserEntityID&"' or ReserveID=0) and NPA='"&SelectedNPA&"')ORDER BY ESRD ASC"
...
<!--METADATA TYPE="DesignerControl" endspan-->
    ...
    <tr>
        <td align="left" colSpan="2" width="100"><strong><font face="arial" size="2">&nbsp;NPA:&nbsp; 
           <font color="blue">
            <%Response.Write(session("P1CONPA"))%></font></strong></FONT></td>
...
<INPUT id=SupportingExplanation name=SupportingExplanation size=75 maxlength=100 
                       > 
...
<TR><TD><P>3)</P></TD>
<TD colspan="3"> <P> An ESRD Block consists of 100 consecutive ten-digit ESRDs.  A ten-digit ESRD is in the form NPA-511-XXXX.</P> </TD> </TR>
<TR><TD><P>4)</P></TD>
