...
<%
'****************************************************************************************
'* CVS File:      $RCSfile: xca_Part1app-Pre-Post.asp,v $
...
<tr>
<td wrap align="left" colSpan="3"><strong><font face="Arial" size="2">For Telus Mobility Only - Type Of Service</strong></FONT></td>
    ...
    <tr>
        ...
        <td colSpan="2">
                 ...
                 <input type="radio" name="TestRequired" value="Y" CHECKED style="LEFT: -1px; TOP: 0px"><strong><font face="Arial"></strong> None</FONT>
                 <input type="radio" name="TestRequired" value="N"><strong><font face="Arial"></strong> Pre Paid</FONT>
				 <input type="radio" name="TestRequired" value="N"><strong><font face="Arial"></strong> Post Paid</FONT>
<tr>
<tr>
