...
<TITLE>Open CNA Tasks (due within 14 days)</TITLE>
<%
'****************************************************************************************
'* CVS File:      $RCSfile: OpenCNATasks_some.asp,v $
'* Commit Date:   $Date: 2010/08/11 13:33:16 $ (UTC)
...
<P align="center"><B><BIG>Open CNA Tasks that have a due date within the next 14 days (or earlier)</BIG></B><BR></P>
...
"Where sname='Open' and due_date < (DateAdd(dd,14,getdate())) " & _
"Order By due_date" 
...
<TD align="right"><a href="/xcalogon/OpenCNATasks_all.asp">Show all open tasks</a></B></TD>
</TR>
...
<TR>
<TD align="center"><B>&nbsp;There are no tasks due within 14 days&nbsp;</B></TD>
</TR>
</TABLE>
<%
End if
...
+"$RCSfile: OpenCNATasks_some.asp,v $\n"
+"$Revision: 1.1 $\n"
+"$Date: 2010/08/11 13:33:16 $ (UTC)"
alert(strAlertText)
}
</SCRIPT>
<%
