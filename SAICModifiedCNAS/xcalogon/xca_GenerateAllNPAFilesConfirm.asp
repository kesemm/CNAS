...
<TABLE align=center WIDTH=75.37% BORDER=0 CELLSPACING=0 CELLPADDING=0 height=138 style="HEIGHT: 138px; WIDTH: 670px">
    
    <TR>
        <TD >&nbsp;&nbsp;&nbsp;&nbsp; 
    <TR>
        <TD align=middle><STRONG><FONT face=Arial size=4>You have generated the 
            Available NPA Files for all the NPAs </FONT></STRONG> 
    <TR>
        <TD > 
    <TR>
