...
<%
'****************************************************************************************
'* CVS File:      $RCSfile: xca_Part1app.asp,v $
'* Commit Date:   $Date: 2015/09/25 11:39:10 $ (UTC)
...
*/
			...
			if (formObj.CorrespondenceDate.value == "") {
                alert("You have not filled in the Correspondence Date field. Please type in a valid date and submit again");
                formObj.CorrespondenceDate.focus();
                return false;
            }
            var result=checkdate(formObj.CorrespondenceDate.value) //this one             
            if (result==false)	{
...
sql = "Select * From xca_Entity Inner Join xca_User On xca_Entity.EntityID=xca_User.EntityID where xca_Entity.EntityID = '"&UserEntityID&"' and xca_User.UserName= '"&Replace(uname,"'","''")&"' "
'sql = "Select * from xca_Entity,xca_User where xca_Entity.EntityID = '"&UserEntityID&"' and xca_User.UserName= '"&uname&"' "
...
'Sep 26, 2007 Change 778 to include 250
'Jan 18, 2008 add NPA 581 and 587
'Aug 24, 2009 add NPA 343
'April 22 2010 add 365 and 873
'Oct 06 2010 add 341
'July 23 2012 - double for 819/873 because RC Frontenac is only on NPA 873 at this time
' Jan 13 2013 add 782
' July 20 2015 add 587
' Sep 25 2015 add 548
' Mar 01 2018 add 367
' Apr 16 2018 add 672 and 879
'
If SelectedNPA=343 Then
sqlRC="Select Distinct RateCenter From xca_COCode where NPA=613 Order by RateCenter ASC"
ElseIf SelectedNPA=672 Then
sqlRC="Select Distinct RateCenter From xca_COCode where NPA in (236,250,604,672,778) Order by RateCenter ASC"
ElseIf SelectedNPA=879 Then
sqlRC="Select Distinct RateCenter From xca_COCode where NPA in (709,879) Order by RateCenter ASC"
ElseIf SelectedNPA=367 Then
sqlRC="Select Distinct RateCenter From xca_COCode where NPA in (367,418,581) Order by RateCenter ASC"
...
<tr>
	<td align="right"><font face="arial" size="2"><strong>Last Correspondence Date:&nbsp;&nbsp;</strong></font></td>
	<td align="left" wrap><INPUT id=CorrespondenceDate name=CorrespondenceDate size=12 maxlength=10></td>
</tr>
