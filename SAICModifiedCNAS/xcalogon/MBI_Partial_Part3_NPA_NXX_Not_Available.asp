...
<table align="center" WIDTH="75%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
  <tr>
   ...
   <tr>
    <td colSpan="3"><strong><font face="Arial"><%=aNPA %>-<%= aNXX%> that you have selected does not have any blocks to place in-service or the there is a User/Company mis-match.</td>
	</tr>
  <tr>
    <td colSpan="3">&nbsp;&nbsp;&nbsp;&nbsp; </td>
  </tr>
