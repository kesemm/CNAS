...
SQLstmt = "INSERT INTO xca_ESRD_Part1 (AuthorizedRep,AuthorizedRepTitle,ApplicationDate,OCN,CurrentlyHeld,CurrentlyUsed,Required,Additional,NPA,NXX,ESRD,SupportingExplanation,SyncField, UserID, EntityID,Status,CorrespondenceDate)VALUES ('"&AuthorizedRep&"','"&AuthorizedRepTitle&"','"&ApplicationDate&"','"&OCN&"','"&CurrentlyHeld&"','"&CurrentlyUsed&"','"&Required&"','"&Additional&"','"&NPA&"','"&NXX&"','"&ESRD&"','"&SupportingExplanation&"','"&SyncField&"', '"&UserID&"', '"&EntityID &"','Open','"&CorrespondenceDate&"')"
...
SQLstmt1="Update xca_ESRD Set Status= 'A', EntityID= '"&EntityID&"', Tix='"&RetrieveTix&"',OCN='"&OCN&"' where NPA= '"&NPA&"' and NXX= '"&NXX&"' and ESRD='"&ESRD&"'"
