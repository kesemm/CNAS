...
<form action="MBI_Full_NPA_RC_Post_Part1.asp" method="post" id="MBI_Full_NPA_RC_Input" name="MBI_Full_NPA_RC_Input" onSubmit="return validateForm()">
<html>
<head>
<meta HTTP+EQUIV="Pragma" CONTENT="no-cache">
<title>Part 1 - MBI (Full Based on NPA and Rate Centre)</title>
<script LANGUAGE="JavaScript"> <!--
 ...
 function validateForm()
        {    
           ...
           if (document.MBI_Full_NPA_RC_Input.AuthorizedRep.value == "") {
                alert("You have not filled in the Authorized Rep field. Please type in an Authorized Name and submit again");
                document.MBI_Full_NPA_RC_Input.AuthorizedRep.focus();               
                return false;
            }
            if (document.MBI_Full_NPA_RC_Input.AuthorizedRepTitle.value == "") {
                alert("You have not filled in the Authorized Rep Title field. Please type in an Authorized Name Title and submit again");
                document.MBI_Full_NPA_RC_Input.AuthorizedRepTitle.focus();
                return false;
            }
			if (document.MBI_Full_NPA_RC_Input.ApplicationDate.value == "") {
                alert("You have not filled in the Application Date field. Please type in a valid date and submit again");
                document.MBI_Full_NPA_RC_Input.ApplicationDate.focus();
                return false;
            }
            var result=checkdate(document.MBI_Full_NPA_RC_Input.ApplicationDate.value) //this one             
            if (result==false)	{
            ...
            if (document.MBI_Full_NPA_RC_Input.OCN.value == "") {
                alert("You have not filled in the OCN field. Please type in a 4 characters and submit again");
                document.MBI_Full_NPA_RC_Input.OCN.focus();
                return false;
            }
           if (document.MBI_Full_NPA_RC_Input.OCN.value.length <4) {
...
session("aNXX")=request.querystring("NXX")
SelectedNXX=session("aNXX")
SelectedRC=session("aRC")
...
<tr>
	...
	<td align="left" wrap><INPUT id=AuthorizedRep name=AuthorizedRep size=40 maxlength=35></td></tr>
...
<tr>
<td align="right"><font face="arial" size="2"><strong>Selected Rate Center:&nbsp;&nbsp;</strong></font></td>
<td align="left" wrap><%= SelectedRC %></td>
</tr>
<tr>
