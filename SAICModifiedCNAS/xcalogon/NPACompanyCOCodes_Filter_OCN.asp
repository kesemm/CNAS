...
<TITLE>CNAS NPA Company CO Codes - Filtered by OCN</TITLE>
<%
'****************************************************************************************
'* CVS File:      $RCSfile: NPACompanyCOCodes_Filter_OCN.asp,v $
...
<P align="center"><B><BIG>Company CO Codes List for NPA: <%=request.querystring("NPA")%></BIG><br><br>
Filtered by OCN: <%=request.querystring("OCN")%></B><BR></P>
<%
...
SQLQueryText = "SELECT xca_COCode.OCN,EntityName,NXX,COStatusDescription As Status, " & _
		...
		"and NPA=" & "'" & request.querystring("NPA") & "' " & _
		"and xca_COCode.OCN=" & "'" & request.querystring("OCN") & "' "
...
<TD align="center"><B>&nbsp; OCN</B><br></TD>
<TD align="center"><B>Company</B>
<a href="/xcalogon/NPACompanyCOCodes_Filter_OCN.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=Company&OCN=<%=request.querystring("OCN")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
<TD align="center"><B>&nbsp; NXX</B>
<a href="/xcalogon/NPACompanyCOCodes_Filter_OCN.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=NXX&OCN=<%=request.querystring("OCN")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
<TD align="center"><B>Status</B>
<a href="/xcalogon/NPACompanyCOCodes_Filter_OCN.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=Status&OCN=<%=request.querystring("OCN")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
<TD align="center"><B>CLLI</B>
<a href="/xcalogon/NPACompanyCOCodes_Filter_OCN.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=CLLI&OCN=<%=request.querystring("OCN")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
<TD align="center"><B>Exchange</B>
<a href="/xcalogon/NPACompanyCOCodes_Filter_OCN.asp?NPA=<%=request.querystring("NPA")%>&SortOrder=Exchange&OCN=<%=request.querystring("OCN")%>">
<image style="border: 0px solid ;" src="/xcalogon/SortImage.gif"/></a><br></TD>
</TR>
<%
...
+"$RCSfile: NPACompanyCOCodes_Filter_OCN.asp,v $\n"
+"$Revision: 1.3 $\n"
