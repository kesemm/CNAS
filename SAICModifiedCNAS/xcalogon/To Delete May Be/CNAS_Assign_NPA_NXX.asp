...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='204' or NPA='306' or NPA='807' or NPA='867')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='250' or NPA='403' or NPA='604' or NPA='778' or NPA='780' or NPA='867')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='289' or NPA='416' or NPA='519' or NPA='613' or NPA='647' or NPA='705' or NPA='905')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='306' or NPA='204' or NPA='403' or NPA='780' or NPA='867')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
Elseif aNPA=403 Then
SQLNPANXXQry = "SELECT NPA,NXX,COStatusDescription,xca_COCode.OCN,EntityName,RateCenter,PublicRemarks,CNARemarks From xca_COCode Left Join xca_status_codes On xca_COCode.Status=xca_status_codes.COStatus Left Join xca_Entity On xca_COCode.EntityID=xca_Entity.EntityID Where (NPA=403 or NPA=250 or NPA=306 or NPA=780)  AND NXX='" & aNXX & "' Order by NPA,NXX;"
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='403' or NPA='250' or NPA='306' or NPA='780')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='416' or NPA='289' or NPA='647' or NPA='905')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
Elseif aNPA=418 Then
SQLNPANXXQry = "SELECT NPA,NXX,COStatusDescription,xca_COCode.OCN,EntityName,RateCenter,PublicRemarks,CNARemarks From xca_COCode Left Join xca_status_codes On xca_COCode.Status=xca_status_codes.COStatus Left Join xca_Entity On xca_COCode.EntityID=xca_Entity.EntityID Where (NPA=418 or NPA=506 or NPA=709 or NPA=819)  AND NXX='" & aNXX & "' Order by NPA,NXX;"
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='418' or NPA='506' or NPA='709' or NPA='819')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='450' or NPA='514' or NPA='613' or NPA='819' or NPA='418')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
Elseif aNPA=506 Then
SQLNPANXXQry = "SELECT NPA,NXX,COStatusDescription,xca_COCode.OCN,EntityName,RateCenter,PublicRemarks,CNARemarks From xca_COCode Left Join xca_status_codes On xca_COCode.Status=xca_status_codes.COStatus Left Join xca_Entity On xca_COCode.EntityID=xca_Entity.EntityID Where (NPA=506 or NPA=418 or NPA=902)  AND NXX='" & aNXX & "' Order by NPA,NXX;"
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='506' or NPA='418' or NPA='902')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
Elseif aNPA=514 Then
SQLNPANXXQry = "SELECT NPA,NXX,COStatusDescription,xca_COCode.OCN,EntityName,RateCenter,PublicRemarks,CNARemarks From xca_COCode Left Join xca_status_codes On xca_COCode.Status=xca_status_codes.COStatus Left Join xca_Entity On xca_COCode.EntityID=xca_Entity.EntityID Where (NPA=514 or NPA=450 or NPA=418 or NPA=819)  AND NXX='" & aNXX & "' Order by NPA,NXX;"
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='514' or NPA='450' or NPA='418' or NPA='819')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
Elseif aNPA=519 Then
SQLNPANXXQry = "SELECT NPA,NXX,COStatusDescription,xca_COCode.OCN,EntityName,RateCenter,PublicRemarks,CNARemarks From xca_COCode Left Join xca_status_codes On xca_COCode.Status=xca_status_codes.COStatus Left Join xca_Entity On xca_COCode.EntityID=xca_Entity.EntityID Where (NPA=519 or NPA=289 or NPA=705 or NPA=905)  AND NXX='" & aNXX & "' Order by NPA,NXX;"
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='519' or NPA='289' or NPA='705' or NPA='905')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
Elseif aNPA=604 or aNPA=778 Then
SQLNPANXXQry = "SELECT NPA,NXX,COStatusDescription,xca_COCode.OCN,EntityName,RateCenter,PublicRemarks,CNARemarks From xca_COCode Left Join xca_status_codes On xca_COCode.Status=xca_status_codes.COStatus Left Join xca_Entity On xca_COCode.EntityID=xca_Entity.EntityID Where (NPA=604 or NPA=250 or NPA=778)  AND NXX='" & aNXX & "' Order by NPA,NXX;"
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='604' or NPA='250' or NPA='778')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='613' or NPA='289' or NPA='450' or NPA='705' or NPA='819' or NPA='905')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='705' or NPA='289' or NPA='519' or NPA='613' or NPA='807' or NPA='819' or NPA='905')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
Elseif aNPA=709 Then
SQLNPANXXQry = "SELECT NPA,NXX,COStatusDescription,xca_COCode.OCN,EntityName,RateCenter,PublicRemarks,CNARemarks From xca_COCode Left Join xca_status_codes On xca_COCode.Status=xca_status_codes.COStatus Left Join xca_Entity On xca_COCode.EntityID=xca_Entity.EntityID Where (NPA=709 or NPA=418 or NPA=819)  AND NXX='" & aNXX & "' Order by NPA,NXX;"
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='709' or NPA='418' or NPA='819')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='780' or NPA='250' or NPA='306' or NPA='403' or NPA='867')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
Elseif aNPA=807 Then
SQLNPANXXQry = "SELECT NPA,NXX,COStatusDescription,xca_COCode.OCN,EntityName,RateCenter,PublicRemarks,CNARemarks From xca_COCode Left Join xca_status_codes On xca_COCode.Status=xca_status_codes.COStatus Left Join xca_Entity On xca_COCode.EntityID=xca_Entity.EntityID Where (NPA=807 or NPA=204 or NPA=705)  AND NXX='" & aNXX & "' Order by NPA,NXX;"
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='807' or NPA='204' or NPA='705')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='819' or NPA='418' or NPA='450' or NPA='613' or NPA='705' or NPA='709')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
...
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='867' or NPA='204' or NPA='250' or NPA='306' or NPA='780')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
Elseif aNPA=902 Then
SQLNPANXXQry = "SELECT NPA,NXX,COStatusDescription,xca_COCode.OCN,EntityName,RateCenter,PublicRemarks,CNARemarks From xca_COCode Left Join xca_status_codes On xca_COCode.Status=xca_status_codes.COStatus Left Join xca_Entity On xca_COCode.EntityID=xca_Entity.EntityID Where (NPA=902 or NPA=506)  AND NXX='" & aNXX & "' Order by NPA,NXX;"
SQLLERGQry="SELECT Distinct NPA,NXX,OCN,[RC_NAME],[RC_ST], [MAJOR_VERT],[MAJOR_HORZ] FROM [LERG6] Where  (NPA='902' or NPA='506')  AND NXX='" & aNXX & "' Order by NPA,NXX;"
End if 
...
<%
aDistance=round(1.61*sqr((aMV-rstLERGQry("MAJOR_VERT"))*(aMV-rstLERGQry("MAJOR_VERT"))+(aMH-rstLERGQry("MAJOR_HORZ"))*(aMH-rstLERGQry("MAJOR_HORZ")))/3,1)
...
%>
  <tr align="center">
    ...
    <td nowrap><small><%= rstLERGQry("RC_NAME") %>, <%= rstLERGQry("RC_ST") %></small>
</td>
    <td nowrap><small><%= rstLERGQry("MAJOR_VERT") %></small>
</td>
    <td nowrap><small><%= rstLERGQry("MAJOR_HORZ") %></small>
</td>
...
<% aLERGQry=aLERGQry+Trim(rstLERGQry("NPA"))+chr(44)+ Trim(rstLERGQry("NXX"))+chr(44)+ Trim(rstLERGQry("OCN"))+chr(44)+ Trim(rstLERGQry("RC_NAME"))+  chr(44) + Trim(rstLERGQry("RC_ST")) + chr(44)+  Trim(rstLERGQry("MAJOR_VERT")) + chr(44)+ Trim(rstLERGQry("MAJOR_HORZ")) + chr(44)+  CSTR(aDistance) + chr(44)+ aWarning + chr(44)+ chr(13)%>
<% rstLERGQry.moveNext
 loop %>
</table>
