...
<TABLE align=center WIDTH=75% BORDER=0 CELLSPACING=0 CELLPADDING=0>
    ...
    <TR>
        <TD colSpan=3>&nbsp;&nbsp;&nbsp;&nbsp;
    <TR>
        <TD colSpan=3><FONT face=Arial><STRONG>Sorry there is a disconnect between your logon and the Company that you selected. Press the OK Button to return.</FONT></FONT> 
            </STRONG>
    <TR>
        <TD>&nbsp;&nbsp; 
        <TD>
