...
<%
Tix=session("Tix")
NPA=session("ppart4NPA")
NXX=session("ppart4NXX")
twoEmail=session("EMailTo")
%>
...
<TABLE align=center WIDTH=75% BORDER=0 CELLSPACING=0 CELLPADDING=0>
    ...
    <TR>
        <TD colSpan=3>&nbsp;&nbsp;&nbsp;&nbsp;
    <TR>
        <TD colSpan=3><FONT face=Arial><STRONG>You have completed a 
        <br>
        Part 4: Confirmation of Code 
            Activation Form for:</FONT></FONT> </STRONG>
    <TR>
        <TD>&nbsp;&nbsp; 
        <TD>
        <TD>
