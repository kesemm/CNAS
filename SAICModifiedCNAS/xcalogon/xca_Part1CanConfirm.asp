...
NPA=session("CanNPA")
NXX=session("CanNXX")
Tix=session("P1CanTix")
twoEmail=session("P1CanEmail")
%>
...
<TABLE align=center WIDTH=75% BORDER=0 CELLSPACING=0 CELLPADDING=0>
    ...
    <TR>
        <TD colSpan=3>&nbsp;&nbsp;&nbsp;&nbsp;
    <TR>
        <TD colSpan=3><FONT face=Arial><STRONG>You have cancelled a 
        <br>
        Part 1: Canadian Central Office Code (NXX) Assignment Request 
            Form for:</FONT></FONT> </STRONG>
    <TR>
        <TD>&nbsp;&nbsp; 
        <TD>
        <TD>
    ...
    <TR>
        ...
        <TD>
    <TR>
        <TD nowrap align=left><font face=Arial size=3>Confirmation Email <br>is 
            being sent to:</font></TD>
